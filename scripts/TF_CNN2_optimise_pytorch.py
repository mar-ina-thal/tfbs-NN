...
# File path
file_path = "/mnt/raid1/thalassini/home/Downloads/target_names_6.txt"

# Read the file and create a list of tf names
with open(file_path, 'r') as file:
    tf_names = [line.strip() for line in file if line.strip()]
...
for tf in tf_names:
        ...
        print(tf)
        file_path = f'/mnt/raid1/thalassini/home/filtered_fimo_200b/{tf.upper()}/datasets/data.csv'
        ...
        def objective_conv2(trial):
            # Define hyperparameters to be optimized
            out_channels1 = trial.suggest_int("out_channels1", 10, 20)
            kernel_size1 = trial.suggest_int("kernel_size1", 10, 20 )
            ...
            # Define the model
            in_channels = 4  # Adjust based on your input data
            in_features = 16 * 23  # Assuming the input shape after convolutions
            model = Conv2(out_channels1, kernel_size1, out_channels2, kernel_size2, dropout_rate)
        ...
        study.optimize(objective_conv2, n_trials=1)
        ...
        study_file_name =  "CNN2_trial_results.txt"
        ...
        print(f"CNN2 Optimization results saved to: {file_path}")
        ...
        params_file_name = "CNN2_best_params.csv"

        study_path = os.path.join(save_directory, params_file_name)
        ...
        plt.savefig(os.path.join(save_directory, f'{tf}_CNN2_ADAM_BCEWithLogits_seq=200b.png'));plt.title(f"Loss Curves {tf}_CNN2_ADAM_BCEWithLogits_seq=200b.png")
